...
public record DetailsUsersDto(String id, String nome, Email email, Senha senha, String role, String cpf, Date dataCadastro, String telefone, Endereco endereco) {
